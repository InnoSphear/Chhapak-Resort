...
const footerLinks = {
  ...
  events: [
    ...
    { label: "Corporate", href: "/events/corporate-events" },
  ],
};
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
            <div className="lg:col-span-2">
              <Link to="/" className="inline-flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="font-bold text-xl tracking-tight">Chhapak</h2>
                  <p className="text-xs tracking-[0.3em] uppercase text-gold">Resort</p>
                </div>
              </Link>
              <p className="text-white/70 leading-relaxed mb-8 max-w-md">
                A cinematic retreat for stays, celebrations, and signature hospitality. 
                Experience the perfect blend of luxury and nature at our lakeside resort.
              </p>
